        ...
        <div class="w-full md:w-1/3 p-4 h-[70vh]">
            <div class="border rounded-lg p-6 h-full flex flex-col dark:bg-gray-200 dark:border-gray-300">
                ...
                <div class="overflow-y-auto flex-1">
                    ...
                    @empty
                        <div class="flex flex-col items-center justify-center h-full p-8 text-center">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-16 w-16 dark:text-gray-400 mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                            </svg>
                            <h3 class="text-xl font-bold dark:text-gray-500 mb-2">No Activities Found</h3>
                            <p class="dark:text-gray-400">There are no activity logs to display yet.</p>
                        </div>
                    @endforelse
                </div>
            </div>
